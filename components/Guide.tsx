    ...
    <section className='flexCenter flex-col'>
      ...
      <div className='flexCenter max-container relative w-full border-2 border-blue-500'>
        <Image
          ...
          width={1440}
          height={580}
          className='2-full object-cover object-center 2xl:rounded-5xl'
        />
        <div className='absolute bg-white py-8 pl-5 pr-7 rounded-3xl border shadow-md md:left-[5%] lg:top-20'>
          <Image
            src='/meter.svg'
            alt='meter'
            width={16}
